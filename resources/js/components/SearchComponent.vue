<template>
 ...
 -->
        <div
            class="absolute normal-case bg-white border border-gray-400 left-0 right-0 w-108 text-left mb-4 mt-2 rounded-lg shadow overflow-hidden z-10">
            <div class="flex flex-col">
                <a href="#" class="border-b border-gray-400 text-xl cursor-pointer p-4 hover:bg-blue-100">
                    Title here
                    <span class="block font-normal text-sm my-1">Lorem ipsum dolor sit amet consectetur adipisicing
                        elit. Aliquam aut error quo, iure adipisci animi quam magnam voluptates. Doloremque,
                        deserunt?</span>
                </a>
                <div class="font-normal w-full border-b border-gray-400 cursor-pointer p-4">

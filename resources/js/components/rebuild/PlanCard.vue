    ...
    >
        ...
        <div class="flex items-center -mx-4">
            ...
            <div class="px-4 w-3/5">
                <ul class="list-reset text-sm font-medium  text-transistor-navy-lighter -mb-1 ">
                    <li v-for="(feature,i) in features" class="mb-1" v-text="feature"></li>  
                </ul>
            </div>
        </div>
    </button>
...
<script>
    export default {
        ...
        computed: {
            price() {
                //return this.schedule == 'monthly' ? this.monthly : this.yearly ;
                return {

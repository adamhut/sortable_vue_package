<template>
  <div class="relative">
    <a 
        ...
        @keydown.up.exact="startArrowKey"
    ...
    <!-- <div class="absolute right-0 bg-gray-300 border border-gray-200 w-64 mt-2">
    ...
    <ul 
        class="absolute normal-case font-normal right-0 bg-white shadow overflow-hidden rounded w-48 border border-gray-200 mt-2 py-1 z-20"
        v-if="isVisible"
...
export default {
    ...
    methods: {
        ...
        focusItem(){
            this.$refs.dropdown.children[this.focusIndex].children[0].focus();
        }

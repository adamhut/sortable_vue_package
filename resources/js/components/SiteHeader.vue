<template>
    <header class="bg-gray-900">
        ...
        <transition name="nav-dropdown">        
            <nav v-show="isOpen">
                <div class="px-5 pt-2 pb-5 border-gray-800">
                    <a href="#" class="block px-3 py-1 leading-tight font-semibold text-white hover:bg-gray-600">List your
                        property</a>
                    <a href="#"
                        class="mt-1 block px-3 py-1 leading-tight font-semibold text-white hover:bg-gray-600 ">Trips</a>
                    <a href="#"
                        class="mt-1 block px-3 py-1 leading-tight font-semibold text-white hover:bg-gray-600 ">Messages</a>
                </div>
                <div class="px-5 py-5">
                    <div class="flex items-center">
                        <img class="h-10 w-10 object-cover rounded-full border-2 border-gray-600 sm:h-8 sm:w-8"
                            ...
                            alt="">
                        <span class="text-gray-200 font-semibold ml-4">Isla Schoger</span>
                    </div>
                    <div class="mt-5">

<template>
    <header class="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
        <div class="px-4 py-3 flex justify-between xl:w-72 xl:bg-gray-900 xl:justify-center xl:py-5" >
            <div >
            ...
            <div class="flex sm:hidden" :class="{ antialiased:isOpen}">
                <button type="button" @click="toggle" class="px-2">
                    <svg class="h-6 w-6 fill-current text-gray-500 hover:text-white " xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
        ...
        <transition name="nav-dropdown">        
            <nav class="sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-between" :class="{ 'hidden':!isOpen ,'block':isOpen}">
                ...
                <div class="hidden xl:block xl:relative xl:max-w-xs xl:w-full">
                    ...
                    <input
                        class="w-full block border border-transparent bg-gray-200 outline-none focus:outline-none focus:bg-white focus:border-gray-300 text-gray-900  text-white rounded pl-10 pr-4 py-2 "
                ...
                <div class="sm:flex sm:items-center">
                    <div class="px-5 pt-2 pb-5 broder-b border-gray-800 sm:border-b-0 sm:flex sm:py-0 sm:px-0">
                        <a href="#" 
                            class="block px-3 py-1 leading-tight font-semibold text-white hover:bg-gray-600 sm:px-2 sm:text-sm sm:text-sm xl:text-gray-900">
                            List your property
                        </a>
                        <a href="#"
                            class="mt-1 block px-3 py-1 leading-tight font-semibold text-white hover:bg-gray-600 sm:px-2 sm:text-sm sm:ml-2 sm:mt-0 xl:text-gray-900">
                            Trips
                        </a>
                        <a href="#"
                            class="mt-1 block px-3 py-1 leading-tight font-semibold text-white hover:bg-gray-600 sm:px-2 sm:text-sm sm:ml-2 sm:mt-0 xl:text-gray-900">

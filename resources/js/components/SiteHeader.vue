    ...
    <header class="bg-gray-900 sm:flex sm:items-center sm:justify-between">
        <div class="px-4 py-3 flex justify-between">
            ...
            <div class="flex" :class="{ antialiased:isOpen}">
                <button type="button" @click="toggle" class="px-2">
                    <svg class="h-6 w-6 fill-current text-gray-500 hover:text-white sm:hidden" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
        ...
        <transition name="nav-dropdown">        
            <nav class="sm:flex sm:items-center xm:px-4" :class="{ 'hidden':!isOpen ,'block':isOpen}">
                <div class="px-5 pt-2 pb-5 broder-b border-gray-800 sm:border-b-0 sm:flex sm:py-0 sm:px-0">
                    <a href="#" class="block px-3 py-1 leading-tight font-semibold text-white hover:bg-gray-600 sm:px-2 sm:text-sm sm:text-sm">List your
                        property</a>
                    <a href="#"
                        class="mt-1 block px-3 py-1 leading-tight font-semibold text-white hover:bg-gray-600 sm:px-2 sm:text-sm sm:ml-2 sm:mt-0">Trips</a>
                    <a href="#"
                        class="mt-1 block px-3 py-1 leading-tight font-semibold text-white hover:bg-gray-600 sm:px-2 sm:text-sm sm:ml-2 sm:mt-0">Messages</a>
                </div>
                <div class="px-5 py-5 sm:py-0 sm:px-0 sm:ml-4">
                    <div class="flex items-center">
                        <img class="h-10 w-10 object-cover rounded-full border-2 border-gray-600 sm:h-8 sm:w-8"
...
<style lang="scss" scoped>
    .nav-dropdown-enter-active, .nav-dropdown-leave-active {
        transition: all .1s ease-in-out;
    }
    .nav-dropdown-enter, .nav-dropdown-leave-to {
        opacity: 0;

<template>
    ...
    <div >
        ...
        <div class=" pb-5/6 relative ">
            <img class="absolute h-full w-full w-full object-cover rounded-lg shadow-md" :src="property.imageUrl" alt="images">
        </div>
        <div class="px-4 -mt-16 relative ">
            <div class="p-6 bg-white rounded-lg shadow-lg">
                ...
                <h4 class="mt-1 font-semibold text-lg leading-tight truncate" :alt="property.title">{{property.title}}</h4>
                <div class="mt-1">

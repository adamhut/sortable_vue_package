    ...
    <div class="md:w-custom mx-auto py-8 md:flex md:justify-between md:flex-wrap"> 
        ...
        >
            <div class="flex justify-between items-center mb-3">
                <h1 class="uppercase text-base tracking-wide text-blue-darker">Hobby</h1>
                <div>
            ...
            </div><!--End Box Header Section-->
            <div class="mb-1 font-semibold text-blue-darker">
                <span class="text-4xl mr-2">1</span>
                <span class="text-2xl">GB</span>
            </div>
            <div>
                <span class="text-xl text-blue-alternate tracking-tight">$</span><span class="text-xl font-semibold text-blue-darker">5</span>
                <span class="text-xl  text-blue-alternate mx-1">/</span>
                <span class="text-xl text-blue-alternate">mo</span>
            </div>
       ...
       <div class="w-48 
        ...
        >
            ...
            <div>
                <span class="text-xl text-blue-alternate tracking-tight">$</span><span class="text-xl font-semibold text-blue-darker">10</span>
                <span class="text-xl  text-blue-alternate mx-1">/</span>
                <span class="text-xl text-blue-alternate">mo</span>
            </div>
        ...
        >
            ...
            <div class="mb-1 font-semibold text-blue-darker">
                <span class="text-4xl mr-2">10</span>
                <span class="text-2xl">GB</span>
            </div>
            <div>
                <span class="text-xl text-blue-alternate tracking-tight">$</span><span class="text-xl font-semibold text-blue-darker">15</span>
                <span class="text-xl  text-blue-alternate mx-1">/</span>
                <span class="text-xl text-blue-alternate">mo</span>
            </div>
        ...
        >
            ...
            <div class="mb-1 font-semibold text-blue-darker">
                <span class="text-4xl mr-2">20</span>
                <span class="text-2xl">GB</span>
            </div>
            <div>
                <span class="text-xl text-blue-alternate tracking-tight">$</span><span class="text-xl font-semibold text-blue-darker">20</span>
                <span class="text-xl  text-blue-alternate mx-1">/</span>
                <span class="text-xl text-blue-alternate">mo</span>
            </div>

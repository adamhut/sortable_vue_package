...
<body class="bg-gray-200">
    <div id="app" class="bg-gray-200 antialiased min-h-screen">
        <header class="bg-gray-900 px-4 py-3 flex justify-between items-center">
            <div>
            ...
            <div class="flex">
                <button class="px-2 text-gray-500">
        ...
        <section class="flex justify-between bg-gray-800 py-3 px-4">
            ...
            <div class="relative">
                ...
                <input class="bg-gray-900 outline-none focus:outline-none focus:bg-white focus:text-gray-900  text-white rounded pl-10 pr-4 py-2 " type="text" placeholder="Search by keywords">
            </div>
            <button class="inline-flex bg-gray-700 rounded-lg shadow pr-2 pl-3 hover:bg-gray-600 focus:shadow-outline">
                <svg class="h-6 w-6 fill-current text-gray-500" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path
        d="M3 6a1 1 0 0 1 1-1h16a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1zm3 6a1 1 0 0 1 1-1h10a1 1 0 1 1 0 2H7a1 1 0 0 1-1-1zm4 5a1 1 0 1 0 0 2h4a1 1 0 1 0 0-2h-4z" /></svg>

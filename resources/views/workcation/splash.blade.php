...
<body class="antialiased bg-gray-100">
    <div class="px-8 py-12 max-w-xl lg:max-w-full lg:px-0 lg:py-20 lg:relative lg:min-h-screen">
        ...
        <img class="mt-8 h-56 w-full object-cover object-center rounded-lg shadow-xl lg:absolute lg:inset-y-0 lg:right-0 lg:w-5/12 lg:h-full lg: lg:mt-0 lg:shadow-none lg:rounded-none lg:object-left " src="/images/workcation/beach-work.jpg" alt="Woman worcationing on beach"/>

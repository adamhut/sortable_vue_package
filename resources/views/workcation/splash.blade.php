...
<body class="antialiased bg-gray-100">
    <div class="px-8 py-12 max-w-xl lg:max-w-full lg:px-0 lg:py-20 lg:relative lg:min-h-screen">
        ...
        <div  class="mt-8 lg:mt-0 lg:absolute lg:inset-y-0 lg:right-0 lg:w-5/12">
            <img class="h-56 w-full object-cover object-center sm:h-56 rounded-lg shadow-xl lg:inset-0 lg:h-full lg:object-left lg:shadow-none lg:rounded-none" src="/images/workcation/beach-work.jpg" alt="Woman worcationing on beach"/>
            <svg class="hidden lg:block absolute inset-y-0 left-0 w-16 h-full" preserveAspectRatio="none"  viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <polygon class="text-gray-100" fill="currentColor" points="0,0 0,100 100,0"></polygon>
            </svg>
        </div>
        
        <h1 class="mt-8 text-3xl lg:mt-12 sm:text-4xl font-bold font-semibold text-gray-900 leading-tight">
            You can work from anywhere.
            <br class="hidden sm:inline"/>
            <span class="text-indigo-500">Take adventage of it.</span>
        </h1>
        ...
        <div class="mt-6">
            <a href="#" class="px-5 py-3 inline-block bg-indigo-500 hover:bg-indigo-400 text-white font-medium tracking-wide uppercase font-semibold rounded-lg">Book your escapes</a>
        </div>
        </div>
    </div>
    </div>

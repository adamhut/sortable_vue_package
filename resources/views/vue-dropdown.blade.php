        ...
        <div class="bg-gray-100 min-h-screen pt-80 lg:pt-40 text-lg">
            <div class="container mx-auto px-8 lg:px-48">
                <div class="pb-16">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut dicta incidunt ea ut commodi quidem
                        temporibus illo quia. Et itaque deleniti veniam tempore facere ipsum animi totam culpa minima
                        vel voluptatem adipisci natus blanditiis similique sunt expedita, ex dicta doloremque repellat
                        vitae temporibus. Quisquam quia, accusantium blanditiis architecto facilis saepe! Lorem ipsum
                        dolor sit amet consectetur adipisicing elit. Ad unde laborum ut suscipit iure aliquam sapiente
                        doloribus exercitationem nam sint.</p>
                </div>
                <div class="pb-16">
                    <div class="mb-4 text-2xl font-bold">This is a title</div>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut dicta incidunt ea ut commodi quidem

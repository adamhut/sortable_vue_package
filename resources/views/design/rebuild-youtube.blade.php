...
<head>
  ...
  <link href="{{ asset('css/rebuild-youtube.css') }}" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"/>
</head>
<body class="bg-grey-lighter">
  <div class="top-bar shadow px-8 py-3 grid grid-columns-12">
    <div class="col-span-12 lg:col-span-2 flex items-center">
      <div class="mr-8"><a href="#"><i class="fa fa-bars text-grey-dark"></i></a></div>
      <div>
        <a href="#">
          <svg viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" focusable="false" class="w-24 style-scope ytd-topbar-logo-renderer"
  ...
  <div class="col-span-12 lg:col-span-10 flex flex-col lg:flex-row items-center justify-between">
    ...
    <div class="flex items-center mt-4 lg:mt-0">
      <a href="#"><i class="fa fa-upload text-grey-darker mr-8"></i></a>
      <a href="#"><i class="fa fa-calendar text-grey-darker mr-8"></i></a>
      <a href="#"><i class="fa fa-bell text-grey-darker mr-8"></i></a>
...
<div class="youtube-body grid grid-columns-12">
  ...
  <div class="youtube-videos col-span-12 lg:col-span-10 container mx-auto py-6">
    ...
    <div class="border-b border-solid my-6"></div>
    
    <div class="flex justify-between items-center mb-6">
      <div class="flex items-center">
        <a href="#"><img src="/images/youtube/avatar1.jpg" alt="avatar" class="rounded-full w-8 mr-2"></a>
    ...
    <div class="grid grid-columns-1 lg:grid-columns-5 grid-gap-2 mb-6">
      <div>
        <a href="#"><img src="/images/youtube/thumbnail01.jpg" alt="thumb" class="mb-1 transition-slow hover:opacity-75"></a>
    ...
    <div class="flex justify-between items-center mb-6">
      <div class="flex items-center">
        <a href="#"><img src="/images/youtube/avatar2.jpg" alt="avatar" class="rounded-full w-8 mr-2"></a>
    ...
    <div class="flex flex-col lg:flex-row">
      <a href="#" class="mr-4"><img src="/image/youtube/thumbnail01.jpg" alt="thumb" class="mb-1 transition-slow hover:opacity-75"></a>

...
<body class="font-sans leading-tight bg-grey">
            ...
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center">
                    ...
                    <div class="text-xl font-semibold ">
                        <a href="#" class="inline-block px-2 py-3 hover:bg-black-20 ">
                            <span>Adam Huang</span>
                            <svg class="fill-current text-blue w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M12.95 10.707l.707-.707L8 4.343 6.586 5.757 10.828 10l-4.242 4.243L8 15.657l4.95-4.95z"/></svg>
                        </a>
                        
                        <a href="#">eleated-stonebraker-70896a</a>
                    </div>
                </div>
                <div>fdfd</div>
            </div>

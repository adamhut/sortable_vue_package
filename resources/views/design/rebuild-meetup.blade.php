...
<body class="bg-gray-200 font-sans font-normal text-black">
        ...
        <ul class="flex items-center justify-center text-sm text-gray-600">
            ...
            <li>
                <a href="#" class="flex items-center">
                    <img src="https://avatars0.githubusercontent.com/u/4724832?s=460&v=4" alt="avatar" class="rounded-full h-8 w-8">
    ...
    <div class="container mx-auto px-40 mb-6">
        <div class="bg-gray-900 text-white flex items-center justify-between p-3 -mt-8">
            ...
            <div class="flex items-center">
                ...
                <button class="border-r border-t border-b border-gray-700 bg-gray-700 text-white px-6 py-2">Calendar</button>
            </div>
        </div>
    </div><!-- End of Container-->
    <div class="container mx-auto px-40 flex">
        <div class="w-7/10">

...
<head>
    ...
    {{-- <link rel="stylesheet" href="/css/iframe.css?id=21f7f551bed1141b910a"> --}}
    {{-- <script src="/js/iframe.js?id=1564701a250e51c06261"></script> --}}
</head>
        ...
        <div id="app" class="h-screen flex flex-col">
            <header class="flex flex-shrink-0">
                <div class="flex-shrink-0 px-4 py-3 bg-gray-700 lg:w-64 lg:bg-gray-800">
                    <button @click="sidebarOpen = true" class="block text-gray-400 hover:text-gray-200 sm:hidden">
            ...
            <div class="flex-1 flex overflow-hidden">
                <div :class="sidebarOpen ? 'translate-x-0 ease-out transition-slow' : '-translate-x-full ease-in transition-medium'"
                    ...
                    <div class="absolute top-0 left-0 pl-4 pt-3 sm:hidden">
                        <button @click="sidebarOpen = false" class="block text-gray-600 hover:text-gray-800">
                            <svg class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                                <path
                    ...
                    <nav class="mt-16 sm:mt-0">
                        ...
                        <div class="mt-8 px-6">
                            ...
                            <h2 class="mt-8 text-xs font-semibold text-gray-600 uppercase tracking-wide">
                                Folders
                            </h2>
                            <div class="mt-4">
                ...
                <main class="flex-1 flex bg-gray-200">
                    <div
                        ...
                        <div class="flex-shrink-0 px-4 py-2 flex items-center justify-between border-b bg-gray-200">
                        ...
                        <div class="flex-1 overflow-y-auto">
                            <div class="shadow">
                                <div>
                                    <a href="#" class="block px-6 pt-3 pb-4 bg-indigo-100 border-l-4 border-indigo-500">
                    ...
                    <div class="flex-1 flex flex-col w-0 overflow-hidden">
                        <div class="relative shadow-md">
                            <div class="flex items-center justify-between px-5 py-4 bg-gray-100 border-b">
                                ...
                                <div class="flex items-center">
                                    <button>
                                        <svg class="h-6 w-6 text-gray-600" viewBox="0 0 24 24" stroke="currentColor"
                                            fill="none">
                                    ...
                                    <button class="ml-2">
                                        <svg class="h-6 w-6 text-gray-600" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor">
                                            <path d="M5 16l7-7 7 7" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                                    </button>
                                </div>
                            ...
                            <div class="flex items-center justify-between px-5 py-4 bg-white">
                                ...
                                <div class="ml-4 flex-shrink-0">
                                    ...
                                    <span
                                        class="ml-2 text-xs font-semibold text-green-900 bg-green-200 rounded-full leading-none px-2 py-1 lg:text-sm">Active</span>
                                </div>
                            </div>
                        </div>
                        <div class="p-3 flex-1 overflow-y-auto">
                            <article class="px-6 pt-4 pb-6 xl:px-10 xl:pt-6 xl:pb-8 bg-white rounded-lg shadow">
                                <div class="flex items-center md:block">
                                    <div>
                                        <img class="md:hidden h-9 w-9 rounded-full object-cover"
                                    ...
                                    <div class="ml-3 md:ml-0 md:flex md:items-center md:justify-between">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <img class="hidden md:block ml-5 h-9 w-9 rounded-full object-cover"
                                                src="https://images.unsplash.com/photo-1463453091185-61582044d556?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=3.5&w=144&h=144&q=80"
                                                alt="" />
                                        </div>
                                    </div>
                            ...
                            <article class="mt-3 px-6 pt-4 pb-6 xl:px-10 xl:pt-6 xl:pb-8 bg-white rounded-lg shadow">
                                ...
                                <div class="mt-4 xl:mt-6 text-gray-800 text-sm">
                                    ...
                                    <p class="mt-4">
                                        ...
                                        Tortor
                                        mauris ornare ut tellus sed aliquet amet venenatis condimentum. Convallis
                                        accumsan
                                        et nunc eleifend.
                                    </p>

...
<body class="bg-white antialiased">
    <div class="h-screen flex overflow-hidden">
        ...
        <div class="w-64 px-8 py-4 bg-gray-100 border-r border-gray-200 overflow-auto">            
        ...
        <div class="flex-1 min-w-0 bg-white flex flex-col overflow-hidden">
            ...
            <div class="overflow-auto flex-1">
                <main class="p-3 inline-flex">
                    <div class="flex-shrink-0 w-80 bg-gray-100 roudned-lg py-3 px-3">
                    ...
                    <div class="ml-3 flex-shrink-0 w-80 bg-gray-100 roudned-lg py-3 px-3">
                        <h3 class="text-sm font-medium text-gray-900">Backlog</h3>
                        <ul class="mt-2">
                            <li class="">
                                <a href="#" class="p-4 block bg-white rounded shadow">

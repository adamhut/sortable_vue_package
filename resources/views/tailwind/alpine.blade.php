...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/tailwind-alpine.css') }}">
...
<body class="bg-gray-100 text-gray-800">
    <header class="border-t-4 border-blue-700 bg-white shadow-md">
        <nav class="container mx-auto px-4 flex items-center justify-between py-6">
            ...
            <div class="relative" x-data="{ isOpen: false }">
                ...
                <ul class="absolute font-normal bg-white shadow overflow-hidden rounded w-48 border border-gray-300 mt-2 py-1 right-0 z-20 transform origin-top-right"
                    x-show="isOpen" 
                    ...
                    <li>
                        <a href="#" class="flex items-center px-3 py-3 hover:bg-gray-200">
                            <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" class="text-gray-600">
    ...
    <div class="container mx-auto px-4 xl:px-64 mt-12">
        ...
        <div class="leading-loose text-lg mt-6" x-data="{
                    faqs: [
                        {
            ...
            <template x-for="faq in faqs" :key="faq">
                <div>
                    ...
                    <div class="text-gray-700 mt-2 transform origin-top-left" 
                        x-show="faq.isOpen"
    ...
    <div class="container mx-auto px-4 xl:px-64 mt-12 mb-12" x-data="{ tab: 'tab1' }">
        ...
        <div class="content bg-white px-4 py-4 border-l border-r border-b pt-4">
            <div x-show="tab === 'tab1'">
                Tab1 content. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt sunt, consectetur eos
                quod perferendis mollitia consequuntur natus, porro molestiae qui iusto deserunt rerum tempore
                voluptatum itaque. Ad, nisi esse cum quidem consequuntur ullam obcaecati id facere beatae accusamus.
                Exercitationem atque consequatur enim accusantium necessitatibus, iure optio omnis minima consequuntur
                earum ab nihil, ea, rerum dolor maxime! Voluptatibus, dolore. Et tempore consectetur aut possimus beatae
                atque harum nemo sed nisi suscipit quia esse, obcaecati? Expedita commodi laboriosam esse dolorem
                debitis fugiat aspernatur, quidem laudantium? Tempore, doloremque autem culpa ad earum veniam odio sed,
                cupiditate possimus quidem veritatis et ex nisi vitae!
            </div>
            <div x-show="tab === 'tab2'">
                Tab2 content. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt sunt, consectetur eos
                quod perferendis mollitia consequuntur natus, porro molestiae qui iusto deserunt rerum tempore
                voluptatum itaque. Ad, nisi esse cum quidem consequuntur ullam obcaecati id facere beatae accusamus.
                Exercitationem atque consequatur enim accusantium necessitatibus, iure optio omnis minima consequuntur
                earum ab nihil, ea, rerum dolor maxime! Voluptatibus, dolore. Et tempore consectetur aut possimus beatae
            ...
            <div x-show="tab === 'tab3'">
                Tab3 content. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt sunt, consectetur eos
                quod perferendis mollitia consequuntur natus, porro molestiae qui iusto deserunt rerum tempore
                voluptatum itaque. Ad, nisi esse cum quidem consequuntur ullam obcaecati id facere beatae accusamus.
                Exercitationem atque consequatur enim accusantium necessitatibus, iure optio omnis minima consequuntur
                earum ab nihil, ea, rerum dolor maxime! Voluptatibus, dolore. Et tempore consectetur aut possimus beatae
